...
namespace Milet.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260831221624_SkontoLoginHaertung")]
    partial class SkontoLoginHaertung
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Milet.Domain.Entities.Admin.Benutzer", b =>
                {
                    ...
                    b.Property<int>("FehlgeschlageneVersuche")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("PasswortWechselErforderlich")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Milet.Domain.Entities.Admin.FibuKonfiguration", b =>
                {
                    ...
                    b.Property<int?>("SkontoDebitorKontoNr")
                        .HasColumnType("int");

                    b.Property<int?>("SkontoKreditorKontoNr")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Milet.Domain.Entities.Verkauf.Beleg", b =>
                {
                    ...
                    b.Property<int?>("StorniertenBelegId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Milet.Domain.Entities.Verkauf.Gutschrift", b =>
                {
                    b.HasBaseType("Milet.Domain.Entities.Verkauf.Beleg");
                    ...
                    b.HasDiscriminator().HasValue("Gutschrift");
                });
            ...
            modelBuilder.Entity("Milet.Domain.Entities.Verkauf.Beleg", b =>
                {
                    ...
                    b.HasOne("Milet.Domain.Entities.Verkauf.Beleg", "StorniertenBeleg")
                        .WithMany()
                        .HasForeignKey("StorniertenBelegId")
                        .OnDelete(DeleteBehavior.Restrict);
